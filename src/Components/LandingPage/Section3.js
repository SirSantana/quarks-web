    ...
    <section className={styles.containerListTalleres}>
      <div className={styles.containerVariedadTalleres}>
        ...
        <div style={{ display: 'flex', gap: '40px', flexDirection: 'column' }}>
          ...
          <p className={styles.subtitle2}>Tenemos a disposicion gratuita un glosario de autopartes donde de manera clara y concisa son explicados partes de tu vehiculo.</p>
