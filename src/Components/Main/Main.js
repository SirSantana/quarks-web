...
export const options = [
  { value: 'Alineación y balanceo', label: 'Alineación y balanceo', index: 0 },
  { value: 'Cambio de aceite', label: 'Cambio de aceite', index: 1 },
  { value: 'Mecanico a Domicilio', label: 'Mecanico a Domicilio', index: 2 },
  { value: 'Mecanica Avanzada', label: 'Mecanica Avanzada', index: 3 },
  { value: 'Mecanica Basica', label: 'Mecanica Basica', index: 4 },
  { value: 'Peritaje', label: 'Peritaje', index: 5 },
  { value: 'Servicio de Aire acondicionado', label: 'Servicio de Aire acondicionado', index: 6 },
  { value: 'Servicio de Baterias', label: 'Servicio de Baterias', index: 7 },
  { value: 'Servicio de Cajas', label: 'Servicio de Cajas', index: 8 },
  { value: 'Servicio de Clutch', label: 'Servicio de Clutch', index: 9 },
  { value: 'Servicio de Eléctricos', label: 'Servicio de Eléctricos', index: 10 },
  { value: 'Servicio de Electronica', label: 'Servicio de Electronica', index: 11 },
  { value: 'Servicio de Frenos', label: 'Servicio de Frenos', index: 12 },
  ...
  { value: 'Servicio de Lujos', label: 'Servicio de Lujos', index: 15 },
  { value: 'Servicio de Motor', label: 'Servicio de Motor', index: 16 },
  { value: 'Servicio de Suspensión', label: 'Servicio de Suspensión', index: 17 },
  { value: 'Taller mecanico', label: 'Taller mecanico', index: 18 },
  { value: 'Tecnico mecanica', label: 'Tecnico mecanica', index: 19 },
];
