...
export default function RecomiendasTaller({onClick, nombre}) {
  return (
    <div onClick={onClick} className={styles.containerHeaderCalendario} style={{ flexDirection: 'row', backgroundColor: '#FFFCE4', alignItems: 'center', gap: '16px',marginTop:'32px', borderColor: '#FBBC04', zIndex:'-1' }}>
