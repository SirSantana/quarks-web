    ...
    <div className={open && styles.modal} >
      ...
      <header ref={ref} className={styles.header2}>
        ...
        <ul className={styles.navv2}>
          ...
          <li className={styles.li}><Link style={{fontSize:'14px', textDecoration: 'none', fontWeight:'500', color: router?.pathname === '/glosario-de-autopartes' ? '#5B0221':'white' }} className={styles.subtitle} href={'/acceso'}>¿Tienes un taller?</Link></li>
