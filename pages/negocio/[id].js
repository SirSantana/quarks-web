...
// import { GET_CALIFICACION_OPINIONES, GET_NEGOCIOVDOS_ONE, GET_ONE_NEGOCIOVDOS, } from "@/graphql/queries"
...
// }
// // export default function Negocio({ data, data2}) {
...
// //         {data?.fotossecundarias?.length>0 && <Galeria data={data} />}
...
// //     {
// //       query:GET_NEGOCIOVDOS_ONE
// //     }
// //   )
// //   console.log(result2, 'holaa');
...
//         {/* {user?.userName === router?.query?.id && <h1>Hola</h1> } */}
//         <CardPerfil data={data} user={user} nameActual={data?.nombre}/>
