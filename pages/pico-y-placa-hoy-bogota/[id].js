...
export default function PicoYPlaceHoyBogota({ data }) {
  return (
    <Layout title={'Pico y Placa Hoy Bogota 15 de Marzo'} description={`Consulta el Pico y Placa de hoy ${data?.titulo?.replaceAll('-', ' ')} en Bogotá de forma rápida y sencilla. Evita multas y planifica tus desplazamientos con nuestra herramienta actualizada al instante. Descubre las restricciones de circulación, horarios y recomendaciones para mejorar tu movilidad en la ciudad. ¡Planifica tu día con anticipación y evita contratiempos en tu ruta!`} keywords={keyWords}>
